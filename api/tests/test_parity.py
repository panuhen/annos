...
async def test_food_search_is_byte_identical_across_surfaces(api, mcp_client, make_food):
    await make_food(
        "Ruisleipä",
        name_fi="Ruisleipä",
        kcal=218,
...
async def test_mcp_scoping_matches_rest_scoping(api, mcp_client, make_food):
    ...
    await make_food("Kaurapuuro", owner_id="someone-else", source="label")
